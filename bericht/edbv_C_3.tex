...
\begin{center}
  ...
  Name & Tätigkeiten\\
    \hline
		...
		\hline
			Bougouma Fall & Matlab-Funktionen: isLegit, getPhase, countOccurences, checkForMill; Bericht Abschnitt 3.6, 4.7\\
		\hline
			Yannic Ellhotka & Matlab-Funktion: threshold, canny; Bericht Abschnitt 3.1, 3.2, 4.2, 4.3, 4.4\\
		\hline
			Lisalotte Tscherteu & Matlab-Funktion: findStein, scoreStore, Bericht Abschnitt: 4.6\\
		\hline
...
<<<<<<< HEAD
1. Wird das Spielfeld richtig eingelesen? \\
Note: Game 3: 9 weiße Steine wurden nicht erkannt. von 24
...
2. Wird ein gültiger Spielzug vorhergesagt?
>>>>>>> 3d2263f5f8acdb34d15457647f2ef97e801caca2
